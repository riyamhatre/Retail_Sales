...
def app():
    ...
    st.write('<p style="font-size:20px;">Let us see some statistics to determine if holidays affect revenue and number of product purchaes</p>', unsafe_allow_html=True)
