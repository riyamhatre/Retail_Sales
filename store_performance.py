...
def app():
    ...
    st.write('<p style="font-size:20px;">Hover over a shaded country to see more stats!</p>', unsafe_allow_html=True)
    ...
    def products_loc_filter(countries):
        ...
        st.write('<p style="font-size:20px;">Understanding product returns is crucial for addressing issues affecting customer satisfaction and operational efficiency. High return rates can indicate problems like poor quality, misleading descriptions, or unmet expectations. Analyzing returns offers insights to improve product design, marketing, and quality control. Tracking patterns can also reveal trends, such as categories or regions with high return rates, requiring targeted action. Reducing returns lowers reverse logistics costs and strengthens customer trust by showing a commitment to delivering value.</p>', unsafe_allow_html=True)
